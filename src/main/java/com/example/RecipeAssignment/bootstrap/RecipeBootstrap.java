package com.example.RecipeAssignment.bootstrap;

import com.example.RecipeAssignment.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        Notes gucamoleNote = new Notes();
        gucamoleNote.setRecipeNotes(
        ...
        gucamoleNote.setRecipe(guacamoleRecipe);
        guacamoleRecipe.setNotes(gucamoleNote);
